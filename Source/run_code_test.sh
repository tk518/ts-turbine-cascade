...
do 
    ...
    do
        echo "mpirun -npernode 4 -np 4 turbostream input_1_psi_"$i"_phi_"$x"_Ma_0.70_slip.hdf5 output_1_psi_"$i"_phi_"$x"_Ma_0.70_slip 1"
        mpirun -npernode 4 -np 4 turbostream input_1_psi_"$i"_phi_"$x"_Ma_0.70.hdf5 output_1_psi_"$i"_phi_"$x"_Ma_0.70 1
    done
done
...
do 
    for x in 0.40 0.60 0.80 1.00 1.20
    do
        mpirun -npernode 4 -np 4 turbostream input_2_psi_"$i"_phi_"$x"_Ma_0.70.hdf5 output_2_psi_"$i"_phi_"$x"_Ma_0.70 1
    done
done
